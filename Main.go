...
func main() {
	...
	for escreq != true { //зацикливаем программу, так обычно нельзя без использования защиты от бесконечного цикла, но для учебных целей сделаем так. Выход из программы по Break в конце
